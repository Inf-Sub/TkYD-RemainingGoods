...
class CSVHandler:
    ...
    #
    #     keys_to_remove = [
    #         key_factory, key_factory_country, key_factory_address, key_new_price, key_discount, key_promo_period,
    #         key_discount, key_organization, key_code, key_description, key_additional_description]
    #
    ...
    #                     row[key_compound] = None
    #
    #                 # удаляем ненужные (в данный момент) данные
